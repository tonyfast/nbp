...
def from_file(path, loader=Notebook):
    ...
    return module.__loader__.exec_module(module)
...
if __name__ ==  '__main__' and not 'develop' in sys.argv:
    from IPython import get_ipython
    __import__('doctest').testmod(verbose=2)
    get_ipython().system('jupyter nbconvert --to script eye.ipynb')
    get_ipython().system('pyreverse -o png -p eye -A eye.py')
